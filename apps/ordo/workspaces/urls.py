...
urlpatterns = [
    ...
    path("tasks/create/", workspace_task_create, name="task-create"),
    path("tasks/<int:task_id>/edit/", workspace_task_edit, name="task-edit"),
    path("tasks/<int:task_id>/move/", workspace_task_move, name="task-move"),
